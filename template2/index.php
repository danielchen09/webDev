...
<html>
  ...
  <head>
    ...
    <link rel="stylesheet" href="pure-release-1.0.0\grids-units.css">
  ...
  <body>
    ...
    <div class="pure-g">
      <div class="pure-u-1-1" style="height: 40vh;padding-left:25%; background: #f7f7f7">
        ...
        <div class="pure-u-1-1" style="width:20%; float:left; padding-top:5%">
          <h1>Publishing</h1>
    ...
    <div class="pure-g">
      <div class="pure-u-1-1" style="height: 60vh; background: white">
        <div class="slidedown">
    ...
    <div class="pure-g">
      <div class="pure-u-1-2" style="height: 80vh; background: white; text-align: center">
      ...
      <div class="pure-u-1-2" style="height: 80vh; background: #eee; text-align: center">
        <img src="img/large-features-4-960x790.jpg" style="width:100%"/>
      </div>
    </div>
    <div class="pure-g">
      <div class="pure-u-1" style="background: #343a40; width: 100%; padding: 0px 1%;">
